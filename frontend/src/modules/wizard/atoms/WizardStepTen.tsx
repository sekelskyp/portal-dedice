      ...
      <Stack spacing={4} alignItems="center">
        <Container maxWidth="container.sm">
          <Heading as={'h3'} size="lg" py={4} px={12} textAlign={'center'}>
            Ne, vyčkejte, až vás notář kontaktuje s případnými dotazy k doplnění
            majetku.
          </Heading>
          <Text py={4} px={16} textAlign={'center'}>
            Notář Vás může případne kontaktovat již kvůli nařízení soudního
            jednání, které je standardně závěrem pozůstalostního řízení.
          </Text>
