    ...
    <Box>
      <Stack spacing={4} alignItems="center">
        <Container maxWidth="container.sm">
          <Heading as={"h3"} size='lg' py={6} px={8} textAlign={'center'}>Po úmrtí člověka vystaví matriční úřad umrtní list, který zasílá  místně příslušnému soudu. Ten následně pověří dle rozvrhu práce příslušného notáře.</Heading>
