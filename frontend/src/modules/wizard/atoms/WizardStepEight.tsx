...
const dummy_data = [
  ...
  },
  {
    ...
    description:
      'Bude potřeba zajistit odhad nemovitosti. Tento odhad za poplatek zpracuje kterákoliv realitní kancelář.',
  },
]

export function WizardStepEight({
  activeStep,
  setActiveStep,
}: WizardStepProps) {
  return (
      ...
      <Stack spacing={4} alignItems="center">
        <Container maxWidth="container.sm">
          <Heading as={'h3'} size="lg" py={6} px={12} textAlign={'center'}>
            S sebou si doneste doklad totožnosti, oddací list, závěť, rodné
            listy. Udělejte si přehled v majetkových záležitostech zůstavitele
            (bakovní účty apod.).
          </Heading>
